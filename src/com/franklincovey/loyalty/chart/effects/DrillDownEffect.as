/**
 * Quietly Scheming Drilldown Effects
 *
 * @copyright   Copyright © 2006, Ely Greenfield
 * @see         http://demo.quietlyscheming.com/drillDown/source/DrillDown.zip
 */
package com.franklincovey.loyalty.chart.effects
{
	...
	public class DrillDownEffect extends TweenEffect
	{
		...
		override protected function initInstance( instance:IEffectInstance ):void
		{
			...
			DrillDownEffectInstance( instance ).drillFromIndex = drillFromIndex;
			DrillDownEffectInstance( instance ).splitDirection = splitDirection;
		}
